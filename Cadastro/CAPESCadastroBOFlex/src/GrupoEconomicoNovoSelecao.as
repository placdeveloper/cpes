package {
	...
	public class GrupoEconomicoNovoSelecao extends GrupoEconomicoInicialView {

		private var servico:ServicoJava = new ServicoJava();
		private static const DESTINO_CAPES:String = "destinoCAPES";

		public function GrupoEconomicoNovoSelecao() {
		...
		private function obterDefinicoesOnResult(event:ResultEvent):void {
			...
			permitirAlterarNomeAutomatico = event.result.dados.permitirAlterarNomeAutomatico as Boolean;
			selecionarTela("NOVO");
		}
