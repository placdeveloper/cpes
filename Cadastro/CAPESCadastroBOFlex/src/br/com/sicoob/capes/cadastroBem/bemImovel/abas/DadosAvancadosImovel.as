package br.com.sicoob.capes.cadastroBem.bemImovel.abas{
	...
	public class DadosAvancadosImovel extends DadosAvancadosImovelView implements IAba {
		...
		public function atualizarCamposRegistro(bem:BemVO):void {
			...
			bemAvancado.idPessoaCompartilhamentoCartorio = pessoaCompartilhamento != null ? pessoaCompartilhamento.idPessoaCompartilhamento : NaN;
    	...
    	public function preencherCampos(bem:BemVO):void {
			...
			if(bemImovelAvancado != null) {
				componenteProcurarPessoa.procurarPorCodigoCompartilhamento(bemImovelAvancado.idPessoaCompartilhamentoCartorio);
