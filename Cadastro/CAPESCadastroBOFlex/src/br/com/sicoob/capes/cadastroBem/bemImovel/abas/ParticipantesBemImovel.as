package br.com.sicoob.capes.cadastroBem.bemImovel.abas{
	...
	import br.com.sicoob.capes.cadastroBem.bemImovel.AssociarParceiro;
	import br.com.sicoob.capes.cadastroBem.bemImovel.AssociarParceiroEvent;
	...
	public class ParticipantesBemImovel extends ParticipantesBemImovelView implements IAba {
		...
		private function acaoBotaoExcluir(evento:Event):void {
			/*if(gridParceiros.selectedItem){
				var lista:ArrayCollection = new ArrayCollection();
				FlexUtil.clonarLista(lista, gridParceiros.dataProvider as ArrayCollection);
				var selectedIndex:int = lista.getItemIndex(gridParceiros.selectedItem);
				lista.removeItemAt(selectedIndex);
				gridParceiros.dataProvider = lista;
