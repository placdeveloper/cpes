package br.com.sicoob.capes.cadastroBem.bemImovel.abas{
	...
	public class DadosBasicosImovel extends DadosBasicosImovelView implements IAba {
		...
		public function atualizarCamposRegistro(bem:BemVO):void {
			...
			bemImovelBasico.tipoLocalizacaoBem = comboTipoLocalizacao.selectedItem as TipoLocalizacaoBemVO;
			bemImovelBasico.tipoUsoBem = comboTipoUso.selectedItem as TipoUsoBemImovelVO;
			bemImovelBasico.tipoBem = comboTipoBem.selectedItem as TipoBemImovelVO;
			...
			bemImovelBasico.unidadeMedida = comboUnidadeMedida.selectedItem as UnidadeMedidaVO;
			...
			if(localidade != null) {
				bemImovelBasico.idLogradouro = FlexUtil.campoNumericoZeroParaNulo(localidade.idLogradouro);
			}
			
			bemImovelBasico.idLocalidade = FlexUtil.campoNumericoZeroParaNulo(Number(componentePesquisaMunicipio.txtValor.text));
			...
			tipoClassificacao.codigo = TipoClassificacaoBemEnum.BEM_IMOVEL.codigo;
			bemImovelBasico.tipoClassificacaoBem = tipoClassificacao;
    	}
    	...
    	public function preencherCampos(bem:BemVO):void {
			...
			if(bemImovel != null){
				FlexUtil.selecionarItemCombo(comboTipoLocalizacao, bemImovel.tipoLocalizacaoBem);
				...
				FlexUtil.selecionarItemCombo(comboUnidadeMedida, bemImovel.unidadeMedida);
    	...
    	public function verificarAlteracoes(bem:BemVO = null):Boolean {
			if(bem == null) {
				...
				if(bemImovel != null) {
					if(FlexUtil.compararObjetos(bemImovel.tipoLocalizacaoBem, comboTipoLocalizacao.selectedItem)
						&& FlexUtil.compararObjetos(bemImovel.tipoUsoBem, comboTipoUso.selectedItem)
						&& FlexUtil.compararObjetos(bemImovel.tipoBem, comboTipoBem.selectedItem)
						&& FlexUtil.compararObjetos(bemImovel.unidadeMedida, comboUnidadeMedida.selectedItem)
		...
		private function retornoObterTipoUsoBem(evento:ResultEvent):void {
			...
			if(_bemImovelAlteracao != null) {
				FlexUtil.selecionarItemCombo(comboTipoUso, _bemImovelAlteracao.tipoUsoBem);
			}
		...
		private function obterTipoBem(evento:Event):void {
			...
			if(_bemImovelAlteracao != null) {
				FlexUtil.selecionarItemCombo(comboTipoBem, _bemImovelAlteracao.tipoBem);
			}
		}
