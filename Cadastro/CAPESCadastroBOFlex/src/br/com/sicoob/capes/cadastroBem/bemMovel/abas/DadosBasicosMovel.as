package br.com.sicoob.capes.cadastroBem.bemMovel.abas{
	...
	public class DadosBasicosMovel extends DadosBasicosMovelView implements IAba {
		...
		public function atualizarCamposRegistro(bem:BemVO):void {
			...
			bemMovelBasico.tipoBem = comboTipoBem.selectedItem as TipoBemMovelVO;
			...
			bemMovelBasico.tipoClassificacaoBem = tipoClassificacao;
    	}
    	...
    	public function preencherCampos(bem:BemVO):void {
			...
			if(bemMovel != null){
				FlexUtil.selecionarItemCombo(comboTipoBem, bemMovel.tipoBem);
    	...
    	public function verificarAlteracoes(bem:BemVO = null):Boolean {
			if(bem == null) {
				...
				if(bemMovel != null) {
					if(!FlexUtil.compararObjetos(bemMovel.tipoBem, comboTipoBem.selectedItem)
