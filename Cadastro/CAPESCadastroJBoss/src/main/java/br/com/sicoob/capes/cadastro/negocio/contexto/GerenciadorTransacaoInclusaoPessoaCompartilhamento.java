...
/**
 * A Classe GerenciadorTransacaoInclusaoPessoaCompartilhamento.
 */
public class GerenciadorTransacaoInclusaoPessoaCompartilhamento implements IGerenciadorTransacao {
	...
	public static IGerenciadorTransacao obterInstancia() {
		if (instancia == null) {
			synchronized (GerenciadorTransacaoInclusaoPessoaCompartilhamento.class) {
				if (instancia == null) {
					instancia = new GerenciadorTransacaoInclusaoPessoaCompartilhamento();
				}
			}
		}
		return instancia;
