...
/**
 * Define as operações do serviço de manipulação de autorização
 * 
...
public interface AutorizacaoServico extends CAPESCadastroCrudServico<Autorizacao> {
	...
	/**
	 * Realiza a alteração, atualizando a lista de documentos
	 * 
	 * @param autorizacao
	 * @param documentos
	 */
	...
	/**
	 * Obtém a lista de documentos em autorização
	 */
