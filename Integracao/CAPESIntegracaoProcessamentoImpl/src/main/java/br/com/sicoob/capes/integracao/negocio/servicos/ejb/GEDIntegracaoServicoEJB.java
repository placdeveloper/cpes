...
import br.com.sicoob.sisbr.ged.api.proc.negocio.delegates.GedApiDocumentoDelegate;
import br.com.sicoob.sisbr.ged.api.proc.negocio.delegates.GedApiDossieDelegate;
...
import br.com.sicoob.sisbr.ged.api.proc.negocio.dto.filtro.IFiltroSiglaSistemaIdRegistroControlado;
import br.com.sicoob.sisbr.ged.api.proc.negocio.dto.filtro.IFiltroValorChaveNegocio;
import br.com.sicoob.sisbr.ged.api.proc.negocio.dto.parametro.GedApiFabricaParametroProcessamento;
import br.com.sicoob.sisbr.ged.api.proc.negocio.dto.parametro.IParametroDossie;
import br.com.sicoob.sisbr.ged.api.proc.negocio.dto.retorno.IRetornoDocumento;
...
public class GEDIntegracaoServicoEJB extends CAPESIntegracaoServicoEJB implements GEDIntegracaoServicoRemote, GEDIntegracaoServicoLocal {
	...
	public void associarDocumentosDossie(GEDIntegracaoDTO dados) throws BancoobException {
		for (Long idDocumento : dados.getListaIdDocumento()) {
			...
			try {
				...
				IFiltroValorChaveNegocio chaveGrupoCompartilhamento = GedApiFabricaFiltros.getInstance().criarFiltroValorChaveNegocio(null, Negocio.GED_SIGLA_CHAVE_NEGOCIO_GRUPO_COMPARTILHAMENTO, dados.getCodCompartilhamentoCadastro().toString());
				...
				IParametroDossie parametro = GedApiFabricaParametroProcessamento.getInstance().criarParametroDossieCriarDossieEAssociarDocumento(idDocumento, dados.getIdRegistroControlado(), TipoPessoaEnum.getSiglaAssuntoGED(dados.getCodTipoPessoa()), Negocio.CTA_SIGLA_SISTEMA, listaChavesNegocio, null);
	...
	public void desassociarDocumentosDossie(String idRegistroControlado, Short codigoTipoPessoa) throws BancoobException {
		...
		try {
			IParametroDossie parametro = GedApiFabricaParametroProcessamento.getInstance().criarParametroDossieDesvincularDocumentoDoDossiePorSiglaSistemaIdRegControlado(
					idRegistroControlado, TipoPessoaEnum.getSiglaAssuntoGED(codigoTipoPessoa), Negocio.CTA_SIGLA_SISTEMA);
			GedApiDossieDelegate dossieDelegate = GedApiFabricaDelegates.getInstance().criarGedApiDossieDelegate();
			dossieDelegate.desvincularDocumentoDoDossiePorSiglaSistemaIdRegControlado(parametro);
		} catch (NegocioException e) {
			throw new GEDIntegracaoNegocioException(e);
		}
	}
