package br.com.sicoob.capes.comum.vo.entidades.bem {
	...
	/**
	 * Classe que representa o tipo padrão de acabamento do bem imóvel.
	 * 
    ...
    public class TipoPadraoAcabamentoBemImovelVO extends CAPESEntidadeVO {
		...
		meta function isInitialized(name:String = null):Boolean {
			...
			return ((!(property is TipoPadraoAcabamentoBemImovelVO) || (property as TipoPadraoAcabamentoBemImovelVO).meta::isInitialized()) &&
