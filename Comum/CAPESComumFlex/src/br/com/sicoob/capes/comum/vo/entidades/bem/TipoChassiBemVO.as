package br.com.sicoob.capes.comum.vo.entidades.bem {
	...
	/**
	 * Classe que representa o tipo de chassi do bem móvel.
	 * 
	 * @author Bruno.Carneiro
	 */
	registerClassAlias("br.com.sicoob.capes.negocio.entidades.bem.TipoChassiBem", TipoChassiBemVO);
    public class TipoChassiBemVO extends CAPESEntidadeVO {
		...
		meta function isInitialized(name:String = null):Boolean {
			...
			return ((!(property is TipoChassiBemVO) || (property as TipoChassiBemVO).meta::isInitialized()) &&
