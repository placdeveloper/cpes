package br.com.sicoob.capes.comum.vo.entidades.bem {
	...
	/**
	 * Classe que representa o tipo de serviço condominial do bem imóvel.
	 * 
    ...
    public class TipoServicoCondominialBemImovelVO extends CAPESEntidadeVO {
		...
		meta function isInitialized(name:String = null):Boolean {
			...
			return ((!(property is TipoServicoCondominialBemImovelVO) || (property as TipoServicoCondominialBemImovelVO).meta::isInitialized()) &&
