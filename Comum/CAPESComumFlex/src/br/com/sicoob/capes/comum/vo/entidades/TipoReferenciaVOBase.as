 ...
 * THE GENERATOR. CHANGE INSTEAD THE INHERITED CLASS (TipoReferenciaVO.as).
 */
...
package br.com.sicoob.capes.comum.vo.entidades {
    ...
    [Bindable]
    public class TipoReferenciaVOBase extends CAPESEntidadeVO {
        ...
        meta function isInitialized(name:String = null):Boolean {
            ...
            return (
                (!(property is TipoReferenciaVO) || (property as TipoReferenciaVO).meta::isInitialized()) &&
