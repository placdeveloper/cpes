package br.com.sicoob.capes.comum.vo.entidades.bem {
	...
	/**
	 * Classe que representa o tipo de classificação do bem.
	 * 
	 * @author Bruno.Carneiro
	 */
	registerClassAlias("br.com.sicoob.capes.negocio.entidades.bem.TipoClassificacaoBem", TipoClassificacaoBemVO);
    public class TipoClassificacaoBemVO extends CAPESEntidadeVO {
		...
		meta function isInitialized(name:String = null):Boolean {
			...
			return ((!(property is TipoClassificacaoBemVO) || (property as TipoClassificacaoBemVO).meta::isInitialized()) &&
