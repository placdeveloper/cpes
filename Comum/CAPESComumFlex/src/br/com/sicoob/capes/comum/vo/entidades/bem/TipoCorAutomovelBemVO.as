package br.com.sicoob.capes.comum.vo.entidades.bem {
	...
	/**
	 * Classe que representa o tipo de cor do automóvel
	 * 
	 * @author Bruno.Carneiro
	 */
	registerClassAlias("br.com.sicoob.capes.negocio.entidades.bem.TipoCorAutomovelBem", TipoCorAutomovelBemVO);
    public class TipoCorAutomovelBemVO extends CAPESEntidadeVO {
		...
		meta function isInitialized(name:String = null):Boolean {
			...
			return ((!(property is TipoCorAutomovelBemVO) || (property as TipoCorAutomovelBemVO).meta::isInitialized()) &&
