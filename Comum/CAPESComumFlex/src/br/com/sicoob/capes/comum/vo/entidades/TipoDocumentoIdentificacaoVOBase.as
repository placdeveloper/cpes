/**
 * Generated by Gas3 v1.1.0 (Granite Data Services) on Fri Aug 26 09:34:11 BRT 2011.
 *
 * WARNING: DO NOT CHANGE THIS FILE. IT MAY BE OVERRIDDEN EACH TIME YOU USE
 * THE GENERATOR. CHANGE INSTEAD THE INHERITED CLASS (TipoDocumentoIdentificacaoVO.as).
 */
...
package br.com.sicoob.capes.comum.vo.entidades {
    ...
    [Bindable]
    public class TipoDocumentoIdentificacaoVOBase extends CAPESEntidadeVO {
        ...
        meta function isInitialized(name:String = null):Boolean {
            ...
            return (
                (!(property is TipoDocumentoIdentificacaoVO) || (property as TipoDocumentoIdentificacaoVO).meta::isInitialized()) &&
