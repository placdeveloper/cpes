...
public class TesteAlterarFonteRendaPessoa extends CAPESFrontofficeTesteAbstrato {

	public TesteAlterarFonteRendaPessoa() {
		super("AlterarFonteRendaServico");
	}
	...
	protected void preencherParametros(List<Parametro> listaParametros) {
		...
		listaParametros.add(obterParametro(ParametroEnum.ID_RENDA, 117277));		
		listaParametros.add(obterParametro(ParametroEnum.COD_TIPO_RENDA, 0));
		listaParametros.add(obterParametro(ParametroEnum.VALOR_TRANSACAO, 696));
