...
public class AlterarTelefonePessoaServicoEJB extends CAPESTransacaoServicoEJB {
	...
	protected RetornoTransacaoObjeto executarTransacao(Mensagem mensagem, Map<String, Parametro> parametros) throws BancoobException {
		TelefoneDTO dto = retornaTelefoneMontado(mensagem, parametros);
		alterarTelefonePessoa(dto);
		RetornoTransacaoObjeto retornoTransacao = new RetornoTransacaoObjeto();
		return retornoTransacao;
	}
	
	private void alterarTelefonePessoa(TelefoneDTO dto) throws BancoobException {
		CAPESApiInclusaoFabricaDelegates.obterInstancia().criarTelefoneDelegate().alterar(dto);
	}
	
	private TelefoneDTO retornaTelefoneMontado(Mensagem mensagem, Map<String, Parametro> parametros)  throws BancoobException {
		...
		telefoneDTO.setIdTelefonePessoa(idTelefonePessoa.longValue());
