...
public class CompartilharCadastroGrupoEconomicoStepEJBTest extends CAPESStepTest {
	...
	public void executar() {
		...
		Parametro parametroDinamico = new Parametro("IDINSTITUICAO", 156, TipoParametro.INTEIRO);
		Parametro parametroPessoaCompartilhamento = new Parametro("idPessoaCompartilhamento", 98754l, TipoParametro.LONGO);
