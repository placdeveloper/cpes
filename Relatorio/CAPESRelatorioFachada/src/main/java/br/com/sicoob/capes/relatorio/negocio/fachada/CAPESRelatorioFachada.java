...
import br.com.sicoob.capes.relatorio.negocio.delegates.CAPESRelatorioFabricaDelegates;
import br.com.sicoob.infraestrutura.log.SicoobLoggerPadrao;

/**
 * A Classe CAPESRelatorioFachada.
 */
public abstract class CAPESRelatorioFachada extends BancoobFachada {
	
	/**
	 * Obter fabrica delegates.
	 *
	 * @return CAPESRelatorioFabricaDelegates
	 */
	protected CAPESRelatorioFabricaDelegates obterFabricaDelegates() {
		return CAPESRelatorioFabricaDelegates.getInstance();
	}
