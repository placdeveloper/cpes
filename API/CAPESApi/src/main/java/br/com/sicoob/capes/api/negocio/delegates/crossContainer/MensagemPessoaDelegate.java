...
public class MensagemPessoaDelegate extends CAPESApiDelegate<MensagemPessoaServico> implements IMensagemPessoaDelegate {
	 ...
	 * 
	 */
	protected MensagemPessoaDelegate() {
	}
	 ...
	 * @return
	 */
	public static MensagemPessoaDelegate getInstance() {
		return valueOf(MensagemPessoaDelegate.class);
	}
	...
	protected MensagemPessoaServico localizarServico() {
		return getLocator().localizarMensagemPessoaServico();
	}
