...
public class DadosEtiquetaDelegate extends CAPESApiDelegate<DadosEtiquetaServico> implements IDadosEtiquetaDelegate {
	 ...
	 * 
	 */
	protected DadosEtiquetaDelegate() {
	}
	 ...
	 * @return
	 */
	public static DadosEtiquetaDelegate getInstance() {
		return valueOf(DadosEtiquetaDelegate.class);
	}
	...
	protected DadosEtiquetaServico localizarServico() {
		return getLocator().localizarDadosEtiquetaServico();
	}
