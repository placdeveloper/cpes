...
public class DataUltimaAtualizacaoDelegate extends CAPESApiDelegate<DataUltimaAtualizacaoServico> implements IDataUltimaAtualizacaoDelegate {
	 ...
	 * 
	 */
	protected DataUltimaAtualizacaoDelegate() {
	}
	 ...
	 * @return
	 */
	public static DataUltimaAtualizacaoDelegate getInstance() {
		return valueOf(DataUltimaAtualizacaoDelegate.class);
	}
	...
	protected DataUltimaAtualizacaoServico localizarServico() {
		return getLocator().localizarDataUltimaAtualizacaoServico();
	}
