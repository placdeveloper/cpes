...
public class GrupoEconomicoDelegate extends CAPESApiDelegate<GrupoEconomicoServico> implements IGrupoEconomicoDelegate {
	 ...
	 * 
	 */
	protected GrupoEconomicoDelegate() {
	}
	 ...
	 * @return
	 */
	public static GrupoEconomicoDelegate getInstance() {
		return valueOf(GrupoEconomicoDelegate.class);
	}
	...
	protected GrupoEconomicoServico localizarServico() {
		return getLocator().localizarGrupoEconomicoServico();
	}
