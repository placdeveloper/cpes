...
public class AnotacaoPessoaDelegate extends CAPESApiDelegate<AnotacaoPessoaServico> implements IAnotacaoPessoaDelegate {
	 ...
	 * 
	 */
	protected AnotacaoPessoaDelegate() {
	}
	 ...
	 * @return
	 */
	public static AnotacaoPessoaDelegate getInstance() {
		return valueOf(AnotacaoPessoaDelegate.class);
	}
	...
	protected AnotacaoPessoaServico localizarServico() {
		return getLocator().localizarAnotacaoPessoaServico();
	}
