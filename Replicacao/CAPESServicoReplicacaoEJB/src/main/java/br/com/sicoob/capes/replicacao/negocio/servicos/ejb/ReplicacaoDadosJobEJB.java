...
/**
 * A Classe ReplicacaoDadosJobEJB.
 */
@Stateless
@Remote(ISicoobContextualJob.class)
public class ReplicacaoDadosJobEJB extends EJBContextualJob {
	
	/** A constante NOME_JNDI_SERVICO_DEFAULT. */
	private static final String NOME_JNDI_SERVICO_DEFAULT = "capes/replicacao/ReplicacaoDadosStepRemote";
