...
/**
 * A Classe ExpurgoJobEJB.
 */
@Stateless
@Remote(ISicoobContextualJob.class)
public class ExpurgoJobEJB extends EJBContextualJob {
	
	/** A constante NOME_JNDI_SERVICO_DEFAULT. */
	private static final String NOME_JNDI_SERVICO_DEFAULT = "capes/replicacao/ExpurgoStepRemote";
